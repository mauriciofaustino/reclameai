...
class ComplaintsTest < ApplicationSystemTestCase
  ...
  test "creating a Complaint" do
    ...
    fill_in "Cep", with: @complaint.cep
    fill_in "Descricao", with: @complaint.descricao
    fill_in "Email", with: @complaint.email
    fill_in "Nome", with: @complaint.nome
    fill_in "Numero pedido", with: @complaint.numero_pedido
    check "Suspeito" if @complaint.suspeito
